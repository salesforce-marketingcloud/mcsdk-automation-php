...
class CampaignApi extends AbstractApi
{
     ...
     * @throws \GuzzleHttp\Exception\GuzzleException
     * @throws \SalesForce\MarketingCloud\ApiException on non-2xx response
     * @return \SalesForce\MarketingCloud\Model\GetAllCampaignsResponse
     */
    public function getAllCampaigns()
    {
        list($response) = $this->getAllCampaignsWithHttpInfo();
        return $response;
    }
     ...
     *
     *
     * @return array of \SalesForce\MarketingCloud\Model\GetAllCampaignsResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws \InvalidArgumentException
     * @throws \GuzzleHttp\Exception\GuzzleException
     * @throws \SalesForce\MarketingCloud\ApiException on non-2xx response
     */
    public function getAllCampaignsWithHttpInfo()
    {
        $returnType = '\SalesForce\MarketingCloud\Model\GetAllCampaignsResponse';
        $request = $this->getAllCampaignsRequest();
     ...
     * @throws Exception\ClientUnauthorizedException
     */
    public function getAllCampaignsAsync()
    {
        return $this->getAllCampaignsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
