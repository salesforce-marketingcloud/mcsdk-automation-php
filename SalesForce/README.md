...
## Installation & Usage
This tutorial  assumes you are in the `mcsdk-automation-php/SalesForce` folder

### Composer

To install the bindings via [Composer](http://getcomposer.org/) go to the SalesForce folder and run the command:
